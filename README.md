...
Our code consists of two parts: first generate all the data based on the SIS-Fact pipeline, then use the data to generate jsonlines training dataset.
...
5. Run `structured_dataset_gen.py` to generate error data based on SIS-Fact.
